...
Where $F_{up}$ is the uptime, $P(Crit)$ is the player's crit chance, and $A$ is the number of attacks made in one cycle of Flurry (3 from auto attack swings, and generally one additional from an instant attack; 4 is a reasonable number for a dual wielding player). Flurry is often misunderstood - the main misconception being that 33% crit will translate to 100% flurry uptime. This is wrong, as we can see graphically: 

```{r Crit Chance vs Flurry Uptime Graph, echo=FALSE, message=FALSE, warning=FALSE}
